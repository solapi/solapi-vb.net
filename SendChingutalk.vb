...
Module SendChingutalk
    ...
    Sub Run()
        ...
        messages.Add(New TextingLib.Message() With {
            ...
            .kakaoOptions = New TextingLib.KakaoOptions() With {
                .pfId = "KA01PF190626020502205cl0mYSoplA2" ' 카카오톡채널 연동 후 발급받은 값을 사용해 주세요
            }
        })

        ' 친구톡 이미지 업로드
        Dim imgResp As TextingLib.Response = TextingLib.UploadKakaoImage("testImage.jpg", "https://example.com") ' 파일명, 이미지 클릭 시 이동할 링크 URL
        ...
        messages.Add(New TextingLib.Message() With {
            ...
            .kakaoOptions = New TextingLib.KakaoOptions() With {
                ...
                .buttons = {
                     New TextingLib.KakaoButton() With {
                        .buttonType = "WL",
                        .buttonName = "시작하기",
